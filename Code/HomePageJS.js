...
const data = [
...

  {
    ...
    description: "Grandslots is an limited payout machines operator in the Western Cape and operates many uplift and expansion efforts in local communities. The Grandslots Bursary aims and funding students applying for undergraduate studies in the Western Cape in the fields of Business Administration, Finance, Marketing, Electrical Engineering and Mechanical Engineering. Bursaries only cover one year of funding but students are encouraged to reapply for funding each year",
...

  {
    ...
    brief: "Electrum is a Cape Town based tech company that offers bursaries to students in the IT realm of study at university's in the wester cape",
    covers: "Tuition fees, Textbook fees, Registration fees",
